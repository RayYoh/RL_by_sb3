...
for env in args.env:  # noqa: C901
    ...
    for algo in args.algos:
        for folder_idx, exp_folder in enumerate(args.exp_folders):
            ...
            log_path = os.path.join(exp_folder, env + '_' + algo.lower())
            ...
            if len(merged_results) > 0:
                ...
                seed = dir_.split('\\')[-1].split('_')[-1]
                plt.plot(timesteps / divider, mean_, label=f"{env}-{algo}_{seed}", linewidth=3)
