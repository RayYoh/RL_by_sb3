...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--algo", help="RL Algorithm (PPO by default)", default="ppo", type=str, required=False, choices=list(ALGOS.keys()),
    )
    parser.add_argument("--env", type=str, default="CartPole-v0", help="environment ID")
    parser.add_argument("--n-env", help="Number of environments for training", default=1, type=int)
    parser.add_argument(
        "-n", "--n-timesteps", help="Overwrite the number of training timesteps", default=int(50000), type=int,
    )
    parser.add_argument(
